export const stack = {
  hardware: [
    { name: "Galaxy Book 2 pro", detail: "Workstation" },
  ...
  skills: {
    hard: [
      ...
      { name: "Database", detail: "PostgreSQL, SQL, CSV" },
      { name: "Tools", detail: "Git, Linux, Jupyter, Expo" },
    ],
    soft: [
      { name: "Project Leadership", detail: "Managed workflows & code reviews" },
      { name: "Collaboration", detail: "Worked with diverse teams (NGOs, Clubs)" },
      { name: "Communication", detail: "Fluent in English & Korean" },
      { name: "Problem Solving", detail: "Abstract logic & Pattern seeking" },
    ],
  },
};
